...
COPY bash/add_shiny.sh /etc/cont-init.d/add
COPY bash/disable_auth_rserver.conf /etc/rstudio/disable_auth_rserver.conf
COPY bash/pam-helper.sh /usr/lib/rstudio-server/bin/pam-helper
